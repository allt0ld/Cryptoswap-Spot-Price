...
three_coin_xps: List[List[List[float]]] = [[[50_000_000, 50_000_000, 50_000_000], \
    ...
    [1_900_000, 55_000_000, 96_000_000], [1_650_000, 65_000_000, 96_000_000], \
                                          ...
                                          [[1, 1, 1], \
    [2.9, 0.035, 0.035], [3.05, 0.03, 0.03], \
    [3, 0.3, 0.45], [3.1, 0.09, 0.2], \
    [2.999, 0.35, 0.2], [3.087, 0.043, 0.08], \
    [0.04, 1.45, 1.45], [0.07, 1.5, 1.5], \
    [0.04, 1.7, 1.297], [0.032, 1.8, 1.32], \
    [0.36, 1.2, 1.77], [0.036, 1.3, 1.7], \
    ], \
